...
### Declare Dag
idxHistNikkei225Dag = DAG('Index_Hist_Nikkei225', description='Index Stock Historical Data - Nikkei 225', schedule_interval= None  ,start_date =datetime(2021,11,15), catchup=False)

dagFunc_execute = PythonOperator(task_id = 'Execution', python_callable=executeIndexApi, dag=idxHistNikkei225Dag)
