...
logPath = "/opt/af-logs/index_ftse100.txt"
...
### Declare Dag
idxFtse100Dag = DAG('Index_FTSE100', description='Daily Index Stock - FTSE 100', schedule_interval='0 18 * * *'  ,start_date =datetime(2021,11,1), catchup=False)

dagFunc_logInit = PythonOperator(task_id = 'InitLogging', python_callable=write_log_init, op_kwargs={'file_path': logPath}, dag=idxFtse100Dag)
dagFunc_execute = PythonOperator(task_id = 'Execution', python_callable=executeIndexApi, dag=idxFtse100Dag)
dagFunc_logEnd = PythonOperator(task_id = 'EndLogging', python_callable=write_log_end, op_kwargs={'file_path': logPath}, dag=idxFtse100Dag)
