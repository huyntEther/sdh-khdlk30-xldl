...
### Declare Dag
idxHistFtseDag = DAG('Index_Hist_FTSE', description='Index Stock Historical Data - FTSE 100', schedule_interval= None  ,start_date =datetime(2021,11,15), catchup=False)

dagFunc_execute = PythonOperator(task_id = 'Execution', python_callable=executeIndexApi, dag=idxHistFtseDag)
