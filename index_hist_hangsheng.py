...
### Declare Dag
idxHistDowjonesDag = DAG('Index_Hist_DowJones', description='Index Stock Historical Data - Dow Jones', schedule_interval= None  ,start_date =datetime(2021,11,15), catchup=False)

dagFunc_execute = PythonOperator(task_id = 'Execution', python_callable=executeIndexApi, dag=idxHistDowjonesDag)
