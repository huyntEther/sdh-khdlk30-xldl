...
### Declare Dag
idxHistSp500Dag = DAG('Index_Hist_SP500', description='Index Stock Historical Data - SP500', schedule_interval= None  ,start_date =datetime(2021,11,15), catchup=False)

dagFunc_execute = PythonOperator(task_id = 'Execution', python_callable=executeIndexApi, dag=idxHistSp500Dag)
